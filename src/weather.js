...
function createDataElements(location) {
  ...
  function showDailyTemp(week, location){
      for (let i = 1; i < 6; i++) {
          ...
          if (location.days[i].icon === 'cloudy'|| location.days[i].icon === 'partly-cloudy-day') {
            dayIcon.src = Cloudy;
  ...
  function showHourlyTemp(div, location){
    for(let i=0; i < location.days[0].hours.length; i++){
        ...
        if (location.days[0].hours[i].icon === 'cloudy'|| location.days[0].hours[i].icon === 'partly-cloudy-day') {
...
function changeBackground(weather) {
    ...
    if (weather.currentConditions.icon === 'rain') {
      ...
      console.log('rainy');
    } else if (weather.currentConditions.icon === 'cloudy'||weather.currentConditions.icon === 'partly-cloudy-day') {
      background.className = 'background';
